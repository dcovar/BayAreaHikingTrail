...
class EditTrailsTableViewController: UITableViewController, UISearchResultsUpdating, NSFetchedResultsControllerDelegate {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "EditTrail"{
            if let indPath = self.tableView.indexPathForSelectedRow{
                ...
                let destinationVC = segue.destinationViewController as! AddTrailViewController
                
                if searchController.active{
                    destinationVC.newTrail = searchResults[indPath.row]
                    destinationVC.editOrAdd = "Edit"
                }
                else{
                    destinationVC.newTrail = trails![indPath.row]
                    destinationVC.editOrAdd = "Edit"
                }
            }
        }
